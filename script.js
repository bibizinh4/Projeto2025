...
const questions = {
    "3serie": {
        ...
        portugues: [
            ...
            {
                question: "Leia o fragmento de crônica a seguir para responder às questões de 7 <br>De quem são os meninos de rua?<br> Eu, na rua, com pressa, e o menino segurou no meu braço, falou qualquer coisa que não entendim presso dizendo que não tinha, certa de que ele estava pedindo dinheiro. Não estava. Queria saber a hora.<br>Talvez não fosse um Menino De Família, mas também não era um Menino De Rua. E assim que a gente divide. Menino De Família é aquele bem-vestido com tênis da moda e camiseta de marca, que usa relógio e a mãe dá outro se o dele for roubado por um Menino De Rua. Menino De Rua é aquele que quando a gente passa perto segura a bolsa com força porque pensa que ele e pivete, trombadinha, ladrão.<br>[...]<br>COLASANTI, Marina. Quem são os meninos de rua? in: COLASANTI, Marina, A casa das palavras.<br>São Paulo: Ática, 2002. (Para gostar de ler).<br>Esse fragmento de crônica aborda principalmente o preconceito relacionado:",
                options: ["ao gênero.", "orientação sexual.", "à idade.", "à aparência física.", "à classe social."],
                correct: 
            }
            {
...
function showResult() {
    ...
    document.getElementsById ("progress").style.width = `100%`;
    ...
    <p><strong>Disciplina:</strong></p>${disciplina.toLowerCase()} | <strong>Série:</strong> ${serie} </p>
